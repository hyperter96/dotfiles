return {
  {
    ...
    opts = {
      ...
      spec = {
        {
          mode = { "n", "v" },
          { "<leader>o", group = "Octo", icon = { icon = "", color = "cyan" } },
          { "<leader>oi", group = "Octo Issues", icon = { icon = "", color = "cyan" } },
          { "<leader>op", group = "Octo Pull Requests", icon = { icon = "", color = "cyan" } },
          { "<leader>oa", group = "Octo Assignee", icon = { icon = "", color = "cyan" } },
          { "<leader>oc", group = "Octo Comment", icon = { icon = "", color = "cyan" } },
          { "<leader>oa", group = "Octo Label", icon = { icon = "", color = "cyan" } },
          { "<leader>oe", group = "Octo React", icon = { icon = "", color = "cyan" } },
          { "<leader>ov", group = "Octo Review", icon = { icon = "", color = "cyan" } },
        },
      },
    },
  },
