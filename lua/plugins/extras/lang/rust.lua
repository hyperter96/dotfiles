    ...
    config = function()
      require('crates').setup({
        on_attach = function(bufnr) 
          ...
          vim.keymap.set("v", "<leader>Cu", crates.update_crates, ext(opts, "desc", "Update Crates Selected in the Visual Mode"))
          ...
          vim.keymap.set("v", "<leader>CU", crates.upgrade_crates, ext(opts, "desc", "Upgrade Crates Selected in the Visual Mode"))
          vim.keymap.set("n", "<leader>CA", crates.upgrade_all_crates, ext(opts, "desc", "Upgrade All Crates"))

          vim.keymap.set("n", "<leader>Cx", crates.expand_plain_crate_to_inline_table, ext(opts, "desc", "Expand a plain crate declaration into an inline table"))
          vim.keymap.set("n", "<leader>CX", crates.extract_crate_into_table, ext(opts, "desc", "Extract an crate declaration from a dependency section"))
